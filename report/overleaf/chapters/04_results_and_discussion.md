...
## Sample Routing and Retrieval Outcomes
...
## Interface and Workflow Discussion
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Figure Placeholder:} Screenshot of the main NexRag welcome screen showing the brand mark, suggested prompts, left sidebar, and message input bar.}}
\end{center}
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Figure Placeholder:} Screenshot of an assistant response showing streamed content, route badge, confidence percentage, and source references under the answer bubble.}}
\end{center}
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Figure Placeholder:} Screenshot of the intelligence panel displaying retrieved sources on one tab and PDF, KG, vector, and LLM status on the other tab.}}
\end{center}
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Figure Placeholder:} Screenshot of the knowledge graph editor view showing Turtle content editing and save controls.}}
\end{center}
...
## Performance Analysis and Log-Based Observations
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Figure Placeholder:} Screenshot or generated result card showing the attendance-rule retrieval output with the KTU handbook source and relevance score.}}
\end{center}
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Figure Placeholder:} Screenshot or generated result card showing the seminar-guideline retrieval output with multiple ranked supporting documents.}}
\end{center}


**Figure 4.6 Retrieval Output for a Seminar Guideline Query**

## Comparative Discussion of Operating Modes
...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Figure Placeholder:} A comparative visual summarizing KG mode, vector mode, combined mode, and no-hit mode with their input evidence and output characteristics.}}
\end{center}
